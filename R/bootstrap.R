...
boot.BTLLasso <- function(model, quantiles = c(0.025, 0.975), 
  B = 500, lambda = NULL, cores = 1, trace = TRUE, trace.cv = TRUE) {
  ...
  estimatesBrepar <- expand.coefs(estimatesB, model$design, 
    model$Y, symmetric = TRUE)
